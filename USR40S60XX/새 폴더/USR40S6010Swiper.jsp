...
<body>
	...
	<div id="iframes">
		<iframe id="iframe-0" data-iframe="0" src="/BT-EMS/usr/board/USR40S6010.do" class="active"></iframe>
		<iframe id="iframe-1" data-iframe="1" src="/BT-EMS/usr/board/USR40S6011.do"></iframe>
		<iframe id="iframe-2" data-iframe="2" src="/BT-EMS/usr/board/USR40S6012.do"></iframe>
		<iframe id="iframe-3" data-iframe="3" src="/BT-EMS/usr/board/USR40S6013.do"></iframe>
		<iframe id="iframe-4" data-iframe="4" src="/BT-EMS/usr/board/USR40S6014.do"></iframe>
	</div>
