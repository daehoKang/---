...
<html>
	<head>
		...
		<script type="text/javaScript" defer="defer">
			...
			function setTextVoiceCtiQ() {
				...
				$('#personalCtiQVoiceSumServiceLevelRate').text(personalAlaSqlResults.SL_RATE);
				$('#personalCtiQVoiceSumRtsWaitCnt').text(personalAlaSqlResults.RTS_WAIT_CNT);
				$('#personalCtiQVoiceSumRtsAvgWaitTime').text(personalAlaSqlResults.RTS_MAXWAIT_TIME);
				...
				$('#companyCtiQVoiceSumServiceLevelRate').text(companyAlaSqlResults.SL_RATE);
				$('#companyCtiQVoiceSumRtsWaitCnt').text(companyAlaSqlResults.RTS_WAIT_CNT);
				$('#companyCtiQVoiceSumRtsAvgWaitTime').text(companyAlaSqlResults.RTS_MAXWAIT_TIME);
				...
				$('#moneyCtiQVoiceSumServiceLevelRate').text(moneyAlaSqlResults.SL_RATE);
				$('#moneyCtiQVoiceSumRtsWaitCnt').text(moneyAlaSqlResults.RTS_WAIT_CNT);
				$('#moneyCtiQVoiceSumRtsAvgWaitTime').text(moneyAlaSqlResults.RTS_MAXWAIT_TIME);
			}
			...
			function setTextChatCtiQ() {
				...
				$('#personalCtiQChatMaxAvgAnsTalkTime').text(personalAlaSqlResults.AVG_ANSTALK_TIME);
	...
	<body>
		...
		<div class="top-div" style="display:flex; width:100%; height:15%;">
			<div id="top-div-title" style="width:80%;height:100%; align-content: center; text-align: center; background-color:white; font-size: 70px; border-radius:10px; ">한국교직원공제회 컨택센터 현황(회원 센터)</div>
		...
		<div class="bottom-div" style="display:flex; width:100%; height:85%;">
			<div class="bottom-div-left" style="width:70%;">
				...
				<div class="bottom-div-content">
					<table>
						...
						<tbody>
							<tr>
								<td>인입콜</td>
								<td><span id="personalCtiQVoiceSumConnCnt">0</span><span>건</span></td>
								<td><span id="companyCtiQVoiceSumConnCnt">0</span><span>건</span></td>
								<td><span id="moneyCtiQVoiceSumConnCnt">0</span><span>건</span></td>
							</tr>
							<tr>
								<td>응대콜</td>
								<td><span id="personalCtiQVoiceSumAnswerCnt">0</span><span>건</span></td>
								<td><span id="companyCtiQVoiceSumAnswerCnt">0</span><span>건</span></td>
								<td><span id="moneyCtiQVoiceSumAnswerCnt">0</span><span>건</span></td>
							</tr>
							<tr>
								<td>응대율</td>
								<td><span id="personalCtiQVoiceSumAnswerRate">0</span><span>%</span></td>
								<td><span id="companyCtiQVoiceSumAnswerRate">0</span><span>%</span></td>
								<td><span id="moneyCtiQVoiceSumAnswerRate">0</span><span>%</span></td>
							</tr>
							<tr>
								<td>서비스레벨</td>
								<td><span id="personalCtiQVoiceSumServiceLevelRate">0</span><span>%</span></td>
								<td><span id="companyCtiQVoiceSumServiceLevelRate">0</span><span>%</span></td>
								<td><span id="moneyCtiQVoiceSumServiceLevelRate">0</span><span>%</span></td>
							</tr>
							<tr>
								<td>대기콜</td>
								<td><span id="personalCtiQVoiceSumRtsWaitCnt">0</span><span>건</span></td>
								<td><span id="companyCtiQVoiceSumRtsWaitCnt">0</span><span>건</span></td>
								<td><span id="moneyCtiQVoiceSumRtsWaitCnt">0</span><span>건</span></td>
							</tr>
							<tr>
								<td>대기시간</td>
								<td><span id="personalCtiQVoiceSumRtsAvgWaitTime">00</span><span>분</span></td>
								<td><span id="companyCtiQVoiceSumRtsAvgWaitTime">00</span><span>분</span></td>
								<td><span id="moneyCtiQVoiceSumRtsAvgWaitTime">00</span><span>분</span></td>
							</tr>
						</tbody>
					</table>
				</div>
			</div>
			<div class="bottom-div-right" style="width:30%;">
				...
				<div class="bottom-div-content">
					<table>
						<tbody>
							<tr>
								<td>인입콜</td>
								<td><span id="personalCtiQChatSumConnCnt">0</span></span>건</span></td>
							</tr>
							<tr>
								<td>응대콜</td>
								<td><span id="personalCtiQChatSumAnswerCnt">0</span></span>건</span></td>
							</tr>
							<tr>
								<td>응대율</td>
								<td><span id="personalCtiQChatSumAnswerRate">0</span></span>%</span></td>
							</tr>
							<tr>
								<td>대기건수</td>
								<td><span id="personalCtiQChatSumRtsWaitCnt">0</span></span>건</span></td>
							</tr>
							<tr>
								<td>처리시간(건당)</td>
								<td><span id="personalCtiQChatMaxAvgAnsTalkTime">0</span></span>초</span></td>
							</tr>
						</tbody>
					</table>
				</div>
