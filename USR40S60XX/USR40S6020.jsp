	...
	<head>
		...
		<script type="text/javaScript" defer="defer">
			...
			function startGetData() {
				...
				.add("USR40S6020-IPRON", {"callback": setIpronMonitoringData, "interval": 5000})
				.add("USR40S6020-3RDPTY", {"callback": set3rdPtyMonitoringData, "interval": 60000})
				.start()
				.enableAutoRecovery();
			}
			...
			function set3rdPtyMonitoringData ($def) {
				var sUrl = "<c:url value='/usr/board/USR40S6020/get3rdPtyData.do'/>"
			...
			function setTextIvrMenuRankGrid() {
				...
				var personalIverServiceMenuStatAlaResult = alasql(strSql,[personalServiceMenuStatDbData]);
				...
				$('#ivrMenuRank4').text(personalIverServiceMenuStatAlaResult[3] === undefined ? '-' : personalIverServiceMenuStatAlaResult[3].menuName);
				$('#ivrMenuRank5').text(personalIverServiceMenuStatAlaResult[4] === undefined ? '-' : personalIverServiceMenuStatAlaResult[4].menuName);
			}
			...
			function setTextVoiceCtiQ() {
				...
				$('#personalCtiQVoiceSumRtsWaitCnt').text(personalAlaSqlResults.RTS_WAIT_CNT);
				...
				$('#companyCtiQVoiceSumRtsWaitCnt').text(companyAlaSqlResults.RTS_WAIT_CNT);
				...
				$('#moneyCtiQVoiceSumRtsWaitCnt').text(moneyAlaSqlResults.RTS_WAIT_CNT);
			...
			function setTextChatCtiQ() {
				...
				var personalAlaSqlResults = alasql(strSql, [allPersonalCtiQRedisData])[0];
				
				console.table(personalAlaSqlResults);
				
				$('#personalCtiQChatSumRtsWaitCnt').text(personalAlaSqlResults.RTS_WAIT_CNT);
				$('#personalCtiQChatSumConnCnt').text(personalAlaSqlResults.SUM_CONN_CNT);
				$('#personalCtiQChatSumAnswerCnt').text(personalAlaSqlResults.SUM_ANSWER_CNT);
				$('#personalCtiQChatSumAnswerRate').text(personalAlaSqlResults.ANSWER_RATE);
				
			}
			
			function setTextVoiceAgentGroup () {
				var personalVoiceCtiQList = ipronMonitoringData.personalVoiceCtiQList;
				var allPersonalVoiceRedisData = personalVoiceCtiQList.allPersonalCtiQRedisData;
				...
				var allPersonalVoiceCtiQAlaResult = alasql(strSql2,[allPersonalVoiceRedisData]);
				console.table(allPersonalVoiceAgentGroupAlaResult);
				console.table(allPersonalVoiceCtiQAlaResult);
				
				$('#personalAgentGroupSumRtsWaitCnt').text(allPersonalVoiceCtiQAlaResult[0].RTS_WAIT_CNT);
				$('#personalAgentGroupVoiceReady').text(allPersonalVoiceAgentGroupAlaResult[0].RTS_READY);
				$('#personalAgentGroupSumConnCnt').text(allPersonalVoiceCtiQAlaResult[0].SUM_CONN_CNT);
				$('#personalAgentGroupSumAnswerCnt').text(allPersonalVoiceCtiQAlaResult[0].SUM_ANSWER_CNT);
			}
			...
			function setTextChatAgentGroup () {
				...
				$('#personalAgentGroupChatSumRtsWaitCnt').text(allPersonalChatCtiQAlaResult[0].RTS_WAIT_CNT);
				$('#personalAgentGroupChatReady').text(allPersonalChatAgentGroupAlaResult[0].RTS_READY);
				$('#personalAgentGroupChatSumConnCnt').text(allPersonalChatCtiQAlaResult[0].SUM_CONN_CNT);
				$('#personalAgentGroupChatSumAnswerCnt').text(allPersonalChatCtiQAlaResult[0].SUM_ANSWER_CNT);
			}
	...
	<body>
		...
		<div style="height: 30%; display: flex;">
			...
			<div class="board-title" style="height: 100%; width:30%;">
				...
				<div style="height:35%; display:grid;">
					<div style="align-self:center; text-align:center; font-size:40px;">회원 컨텍센터 현황판</div>
				</div>
				<div style="height:30%;">
					...
					<div class="common-div-bottom">
						<div class="v-div-container a-v-div-container">
							<div style="color: white; display:grid; text-align:center; width:12%;">
								<div style="align-self:center; font-size:50px;">개인</div>
							</div>
							<div>
								<div class="v-div-container-title">고객대기</div>
								<div class="v-div-container-value"><div id="personalCtiQVoiceSumRtsWaitCnt">0</div></div>
							</div>
							<div>
						...
						<div class="v-div-container a-v-div-container">
							<div style="color: white; display:grid; text-align:center; width:12%;">
								<div style="align-self:center; font-size:50px;">법인</div>
							</div>
							<div>
								<div class="v-div-container-title">고객대기</div>
								<div class="v-div-container-value"><div id="companyCtiQVoiceSumRtsWaitCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">인입콜</div>
								<div class="v-div-container-value"><div id="companyCtiQVoiceSumConnCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">응대콜</div>
								<div class="v-div-container-value"><div id="companyCtiQVoiceSumAnswerCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">응대율</div>
								<div class="v-div-container-value" style="display: flex; justify-content:center;"><div id="companyCtiQVoiceSumAnswerRate">0</div><div>%</div></div>
							</div>
						</div>
						<div class="v-div-container a-v-div-container">
							<div style="color: white; display:grid; text-align:center; width:12%;">
								<div style="align-self:center; font-size:50px;">분회</div>
							</div>
							<div>
								<div class="v-div-container-title">고객대기</div>
								<div class="v-div-container-value"><div id="moneyCtiQVoiceSumRtsWaitCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">인입콜</div>
								<div class="v-div-container-value"><div id="moneyCtiQVoiceSumConnCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">응대콜</div>
								<div class="v-div-container-value"><div id="moneyCtiQVoiceSumAnswerCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">응대율</div>
								<div class="v-div-container-value" style="display: flex; justify-content:center;"><div id="moneyCtiQVoiceSumAnswerRate">0</div><div>%</div></div>
							</div>
						</div>
					</div>
				</div>
				<div style="width:100%;  height:30%">
					...
					<div class="common-div-bottom">
						<div class="v-div-container a2-v-div-container" style="height: 100%">
							...
							<div>
								<div class="v-div-container-title">고객대기</div>
								<div class="v-div-container-value"><div id="personalCtiQChatSumRtsWaitCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">인입콜</div>
								<div class="v-div-container-value"><div id="personalCtiQChatSumConnCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">응대콜</div>
								<div class="v-div-container-value"><div id="personalCtiQChatSumAnswerCnt">0</div></div>
							</div>
							<div>
								<div class="v-div-container-title">응대율</div>
								<div class="v-div-container-value" style="display: flex; justify-content:center;"><div id="personalCtiQChatSumAnswerRate">0</div><div>%</div></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div style="width:100%; height:50%;">
					...
					<div class="common-div-bottom">
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							...
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupSumRtsWaitCnt">0</div></div>
						</div>
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>대기중</div></div>
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupVoiceReady">0</div></div>
						</div>
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>인입호</div></div>
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupSumConnCnt">0</div></div>
						</div>
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>응대호</div></div>
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupSumAnswerCnt">0</div></div>
						</div>
					</div>
				</div>
				<div style="width:100%; height:50%;">
					...
					<div class="common-div-bottom">
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>대기회원</div></div>
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupChatSumRtsWaitCnt">0</div></div>
						</div>
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>대기중</div></div>
						...
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>인입호</div></div>
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupChatSumConnCnt">0</div></div>
						</div>
						<div class="h-div-container" style="height:25%; background-color:#78206E;">
							<div class="h-div-container-title" ><div>응대호</div></div>
							<div class="h-div-container-vale" style="width:65%; text-align: center;"><div id="personalAgentGroupChatSumAnswerCnt">0</div></div>
						</div>
					</div>
				</div>
			</div>
