...
<html>
	<head>
		...
		<script type="text/javaScript" defer="defer">
			...
			function setTextVoiceAgentGroup() {
				...
				var personalVoiceAgentGroupRedisData = alasql(strSql,[allPersonalVoiceAgentGroupRedisData]);
				console.table(personalVoiceAgentGroupRedisData);
				var personalChatAgentGroupRedisData = alasql(strSql,[allPersonalChatAgentGroupRedisData]);
				console.table(personalChatAgentGroupRedisData);
				
				$('#personalAgentGroupVoiceLogin').text(personalVoiceAgentGroupRedisData[0].RTS_LOGIN);
				$('#personalAgentGroupVoiceReady').text(personalVoiceAgentGroupRedisData[0].RTS_READY);
				$('#personalAgentGroupVoiceBusy').text(personalVoiceAgentGroupRedisData[0].RTS_BUSY);
				$('#personalAgentGroupVoiceAcw').text(personalVoiceAgentGroupRedisData[0].RTS_ACW);
				
				$('#personalAgentGroupChatLogin').text(personalChatAgentGroupRedisData[0].RTS_LOGIN);
				$('#personalAgentGroupChatReady').text(personalChatAgentGroupRedisData[0].RTS_READY);
				$('#personalAgentGroupChatBusy').text(personalChatAgentGroupRedisData[0].RTS_BUSY);
				$('#personalAgentGroupChatAcw').text(personalChatAgentGroupRedisData[0].RTS_ACW);
			}
		</script>
	</head>
	...
	<body>
		...
		<div class="top-div" style="display:flex; width:100%; height:15%;">
			<div id="top-div-title" style="width:80%;height:100%; align-content: center; text-align: center; background-color:white; font-size: 65px; border-radius:10px; ">한국교직원공제회 컨택센터 상담사 현황(회원 센터)</div>
		...
		<div class="bottom-div" style="display:flex; width:100%; height:80%;">
			<div class="bottom-div-1" style="width:20%;">
				<div style="height:100%;">
					...
					<div class="bottom-div-content">
						<span id="personalAgentGroupVoiceLogin">0</span>명
					</div>
				</div>
			</div>
			...
			<div class="bottom-div-2" style="width:20%;">
				<div style="height:50%">
					...
					<div class="bottom-div-content">
						<span id="personalAgentGroupVoiceReady">0</span>명
					</div>
				</div>
				<div style="height:50%">
					<div class="bottom-div-title">상담원 대기</div>
					<div class="bottom-div-content">
						<span id="personalAgentGroupChatReady">0</span>명
					</div>
				</div>
			</div>
			<div class="bottom-div-3" style="width:20%;">
				<div style="height:50%">
					...
					<div class="bottom-div-content">
						<span id="personalAgentGroupVoiceBusy">0</span>명
					</div>
				</div>
				<div style="height:50%">
					<div class="bottom-div-title">상담중</div>
					<div class="bottom-div-content">
						<span id="personalAgentGroupChatBusy">0</span>명
					</div>
				</div>
			</div>
			<div class="bottom-div-4" style="width:20%;">
				<div style="height:50%">
					...
					<div class="bottom-div-content">
						<span id="personalAgentGroupVoiceAcw">0</span>명
					</div>
				</div>
				<div style="height:50%">
					<div class="bottom-div-title">후처리</div>
					<div class="bottom-div-content">
						<span id="personalAgentGroupChatAcw">0</span>명
					</div>
				</div>
			</div>
		</div>
